...
public class Communicator extends AppCompatActivity implements BleManager.BleManagerListener {
    // Log
    ...
    public Communicator(BleManager bl) {
        mBleManager = bl;
    }
    ...
    protected void sendData(byte[] data, SendDataCompletionHandler completionHandler) {
        ...
        sendDataRunnable = new Runnable() {
            ...
            public void run() {
                ...
                Communicator.this.sendDataRunnable = null;
                Communicator.this.sendDataCompletionHandler = null;
    ...
    public void onServicesDiscovered() {
        mUartService = BleManager.getInstance(getApplicationContext()).getGattService(UUID_SERVICE);
        Log.w(TAG, "YO MY DUDE: "+ BleManager.getInstance(this).getGattService(UUID_SERVICE));
    }
